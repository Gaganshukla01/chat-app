...
import { Mail, MessageSquare, Eye ,EyeOff ,Lock ,Loader2, User} from "lucide-react";
...
const SignUpPage = () => {
  ...
  const validateForm = () => {
    ...
    if(formData.password.length<6) return toast.error("Password must me atleast 6 charcter")
